 ...
 * @author Vitor Hugo
 */
public class ViewCampus extends javax.swing.JInternalFrame {
    ...
    public ViewCampus() {
        ...
        this.jTable1.setModel(tableModelCampus);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewCampus.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewCampus().setVisible(true);
            }
        });
    }
