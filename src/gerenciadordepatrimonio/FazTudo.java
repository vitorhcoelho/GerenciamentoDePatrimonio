...
//
//    Servidor admTeste = new Servidor();
...
//
//        admTeste.setAdm(true);
//        admTeste.setCampus(2);
//        admTeste.setCargo("Estrategista");
//        admTeste.setEmail("strategy@gmail.com");
//        admTeste.setId(sDAO.geraId());
//        admTeste.setLogado(false);
//        admTeste.setLoginSenha("adm", "1234");
//        admTeste.setNome("Jose da Silva Sauro Alevino");
//        admTeste.setPapel("Gerenciar");
//        admTeste.setSystem(false);
//        sDAO.setServidores(admTeste);
//        
//        s1.setAdm(false);
//        s1.setCampus(1);
