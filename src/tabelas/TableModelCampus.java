...
public class TableModelCampus extends AbstractTableModel {
    ...
    private final String[] colunas = {"ID", "Nome", "Abreviação", "Data de criação", "Cidade", "Bairro", "Endereço", "CEP"};
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
            ...
            case 2:
                return this.listaDeCampus.get(rowIndex).getAbreviacao();

            case 3:
                return this.listaDeCampus.get(rowIndex).getDataCriacao();

            case 4:
                return this.listaDeCampus.get(rowIndex).getCidade();

            case 5:
                return this.listaDeCampus.get(rowIndex).getBairro();

            case 6:
                return this.listaDeCampus.get(rowIndex).getEndereco();

            case 7:
                return this.listaDeCampus.get(rowIndex).getCep();
